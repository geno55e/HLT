...
Combo_Variable = ttk.Combobox(
    master,
    state="readonly",
    values=["Spannung rechts", "Spannung links"]
)
...
Label_Spannung_links_HM8143_Quelle.grid(row=3, column=0, pady=2)
Label_Spannung_rechts_HM8143_Quelle.grid(row=3, column=4, pady=2)

Eingabe_Spannung_links_HM8143_Quelle.grid(row=4, column=0, pady=2)
Eingabe_Spannung_rechts_HM8143_Quelle.grid(row=4, column=4, pady=2)

Label_Strom_links_HM8143_Quelle.grid(row=5, column=0, pady=2)
Label_Strom_rechts_HM8143_Quelle.grid(row=5, column=4, pady=2)

Eingabe_Strom_links_HM8143_Quelle.grid(row=6, column=0, pady=2)
Button_on_off_HM8143_Quelle.grid(row=6, column=1, columnspan=3, pady=2)
Eingabe_Strom_rechts_HM8143_Quelle.grid(row=6, column=4, pady=2)


Label_Ueberschrift_HM8150_Freq.grid(row=7, column=1, columnspan=3, pady=2)

Label_Wellenform_HM8150_Freq.grid(row=8, column=0, pady=2)
Label_Amplitude_HM8150_Freq.grid(row=8, column=2, pady=2)

Label_Frequenz_HM8150_Freq.grid(row=8, column=3, pady=2)
Label_Offset_HM8150_Freq.grid(row=8, column=4, pady=2)

Combo_Wellenform_HM8150_Freq.grid(row=9, column=0, pady=2)
Eingabe_Amplitude_HM8150_Freq.grid(row=9, column=2, pady=2)
Eingabe_Frequenz_HM8150_Freq.grid(row=9, column=3, pady=2)
Eingabe_Offset_HM8150_Freq.grid(row=9, column=4, pady=2)

Label_Output_Button_HM8150_Freq.grid(row=10, column=0, pady=2)
Label_Offset_Button_HM8150_Freq.grid(row=10, column=1, pady=2)

Button_Output_on_off_HM8150_Freq.grid(row=11, column=0, pady=2)
Button_Offset_on_off_HM8150_Freq.grid(row=11, column=1, pady=2)


Label_Ueberschrift_Fluke.grid(row=12, column=1, columnspan=3, pady=2)

Label_Messgroesse_Fluke.grid(row=13, column=0, pady=2)
Label_Messbereich_Fluke.grid(row=13, column=3, pady=2)

Combo_Messgroesse_Fluke.grid(row=14, column=0, pady=2)
Combo_Messbereich_Fluke.grid(row=14, column=3, pady=2)

Label_Variable_Fluke.grid(row=15, column=0, pady=2)
Label_Startwert_Fluke.grid(row=15, column=2, pady=2)
Label_Schrittweite_Fluke.grid(row=15, column=3, pady=2)
Label_Zielwert_Fluke.grid(row=15, column=4, pady=2)

Combo_Variable.grid(row=16, column=0, pady=2)
Eingabe_Startwert_Variable.grid(row=16, column=2, pady=2)
Eingabe_Schrittweite_Variable.grid(row=16, column=3, pady=2)
Eingabe_Zielwert_Variable.grid(row=16, column=4, pady=2)
